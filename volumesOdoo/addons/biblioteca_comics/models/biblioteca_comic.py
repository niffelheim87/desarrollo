...
class BibliotecaComic(models.Model):
    ...
    socio_id = fields.Many2many(
        'biblioteca.socios', string='Socio', through='biblioteca.prestamos')
    ...
    _sql_constraints = [
        ...
        ('positive_page', 'CHECK(paginas>0)',
         'El comic debe tener al menos una página')
    ]
